...
export const WAVES: WaveDef[] = [
  ...
  // Wave 5: mixed assault
  {
    entries: [
      ...
      { kind: EnemyKind.Wanderer, count: 3, hpMultiplier: 1.2 },
    ],
  },
  // Wave 6: sneaker + wanderer pressure
  {
    entries: [
      ...
      { kind: EnemyKind.Wanderer, count: 5, hpMultiplier: 1.3 },
    ],
  },
  // Wave 7: beefy ground
  {
  ...
  {
    entries: [
      { kind: EnemyKind.Walker, count: 8, hpMultiplier: 2.2 },
      { kind: EnemyKind.Sneaker, count: 6, hpMultiplier: 2.0 },
      { kind: EnemyKind.Wanderer, count: 10, hpMultiplier: 1.8 },
    ],
  },
  // Wave 9: penultimate push
  {
    entries: [
      ...
      { kind: EnemyKind.Wanderer, count: 8, hpMultiplier: 2.0 },
    ],
  },
  // Wave 10: everything at once
  {
    entries: [
      ...
      { kind: EnemyKind.Wanderer, count: 10, hpMultiplier: 2.5 },
    ],
  },
];
